...
/*   Updated: 2024/03/15 20:12:00 by tauer            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	init_wall_cosmetics(t_data *data)
{
	...
	add_img_to_garbage_memory(data, &data->textures.private_door,
		"private_door\t      :./img/cosmetic_4_wall/private_door.xpm:0");
	add_img_to_garbage_memory(data, &data->textures.panel_wall,
		"panel_wall\t      :./img/cosmetic_4_wall/pannel_wall.xpm:0");
	add_img_to_garbage_memory(data, &data->textures.wall_screen,
		"wall_screen\t      :./img/cosmetic_4_wall/wall_screen.xpm:0");
...
bool	init_floor(t_data *data)
{
	...
	add_img_to_garbage_memory(data, &data->textures.floor_x,
		"floor_x\t\t      :./img/floor_cosmetics/floor_x.xpm:0");
	add_img_to_garbage_memory(data, &data->textures.floor_ventil,
		"floor_ventil\t      :./img/floor_cosmetics/floor_ventil.xpm:0");
	add_img_to_garbage_memory(data, &data->textures.empty, "empty\t\t      :./img/empty.xpm:0");
	add_img_to_garbage_memory(data, &data->textures.floor, "floor\t\t      :./img/floor.xpm:0");
...
bool	init_rest(t_data *data)
{
	...
	add_img_to_garbage_memory(data, &data->textures.collectibles,
		"collectibles\t      :./img/collectibles.xpm:C");
