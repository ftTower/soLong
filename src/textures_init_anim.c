...
/*   Updated: 2024/03/14 18:04:08 by tauer            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	init_exit(t_data *data)
{
	...
	add_img_to_garbage_memory(data, &data->textures.exit_6, "exit_6\t\t      ",
		"./img/exit/exit_open_6.xpm");
	add_img_to_garbage_memory(data, &data->textures.exit_7, "exit_7\t\t      ",
		"./img/exit/exit_open_7.xpm");
	add_img_to_garbage_memory(data, &data->textures.exit_8, "exit_8\t\t      ",
		"./img/exit/exit_open_8.xpm");
	add_img_to_garbage_memory(data, &data->textures.exit_9, "exit_9\t\t      ",
		"./img/exit/exit_open_9.xpm");
	add_img_to_garbage_memory(data, &data->textures.exit_10,
		"exit_10\t\t      ", "./img/exit/exit_open_10.xpm");
	add_img_to_garbage_memory(data, &data->textures.exit_11,
		"exit_11\t\t      ", "./img/exit/exit_open_11.xpm");
	add_img_to_garbage_memory(data, &data->textures.exit_12,
		"exit_12\t\t      ", "./img/exit/exit_open_12.xpm");
	add_img_to_garbage_memory(data, &data->textures.exit_13,
		"exit_13\t\t      ", "./img/exit/exit_open_13.xpm");
	add_img_to_garbage_memory(data, &data->textures.exit_14,
		"exit_14\t\t      ", "./img/exit/exit_open_14.xpm");
	add_img_to_garbage_memory(data, &data->textures.exit_15,
		"exit_15\t\t      ", "./img/exit/exit_open_15.xpm");
	add_img_to_garbage_memory(data, &data->textures.exit_16,
		"exit_16\t\t      ", "./img/exit/exit_open_16.xpm");
	add_img_to_garbage_memory(data, &data->textures.exit_17,
		"exit_17\t\t      ", "./img/exit/exit_open_17.xpm");
	add_img_to_garbage_memory(data, &data->textures.exit_18,
		"exit_18\t\t      ", "./img/exit/exit_open_18.xpm");
	add_img_to_garbage_memory(data, &data->textures.exit_19,
		"exit_19\t\t      ", "./img/exit/exit_open_19.xpm");
...
bool	init_screen_indoor(t_data *data)
{
	...
	add_img_to_garbage_memory(data, &data->textures.wall_screen_indoor,
		"wall_screen_indoor_0   ",
		"./img/wall_screen_animation/wall_screen_indoor.xpm");
	add_img_to_garbage_memory(data, &data->textures.wall_screen_indoor_1,
		"wall_screen_indoor_1   ",
		"./img/wall_screen_animation/wall_screen_indoor_1.xpm");
	add_img_to_garbage_memory(data, &data->textures.wall_screen_indoor_2,
		"wall_screen_indoor_2   ",
		"./img/wall_screen_animation/wall_screen_indoor_2.xpm");
	add_img_to_garbage_memory(data, &data->textures.wall_screen_indoor_3,
		"wall_screen_indoor_3   ",
		"./img/wall_screen_animation/wall_screen_indoor_3.xpm");
	add_img_to_garbage_memory(data, &data->textures.wall_screen_indoor_4,
		"wall_screen_indoor_4   ",
		"./img/wall_screen_animation/wall_screen_indoor_4.xpm");
	add_img_to_garbage_memory(data, &data->textures.wall_screen_indoor_5,
		"wall_screen_indoor_5   ",
		"./img/wall_screen_animation/wall_screen_indoor_5.xpm");
	add_img_to_garbage_memory(data, &data->textures.wall_screen_indoor_6,
		"wall_screen_indoor_6   ",
		"./img/wall_screen_animation/wall_screen_indoor_6.xpm");
	add_img_to_garbage_memory(data, &data->textures.wall_screen_indoor_7,
		"wall_screen_indoor_7   ",
		"./img/wall_screen_animation/wall_screen_indoor_7.xpm");
	add_img_to_garbage_memory(data, &data->textures.wall_screen_indoor_8,
		"wall_screen_indoor_8   ",
		"./img/wall_screen_animation/wall_screen_indoor_8.xpm");
...
bool	init_screen_outdoor(t_data *data)
{
	...
	add_img_to_garbage_memory(data, &data->textures.wall_screen_outdoor,
		"wall_screen_outdoor_0  ",
		"./img/screen_outdoor_animation/wall_screen_outdoor.xpm");
	add_img_to_garbage_memory(data, &data->textures.wall_screen_outdoor_1,
		"wall_screen_outdoor_1  ",
		"./img/screen_outdoor_animation/wall_screen_outdoor_1.xpm");
	add_img_to_garbage_memory(data, &data->textures.wall_screen_outdoor_2,
		"wall_screen_outdoor_2  ",
		"./img/screen_outdoor_animation/wall_screen_outdoor_2.xpm");
	add_img_to_garbage_memory(data, &data->textures.wall_screen_outdoor_3,
		"wall_screen_outdoor_3  ",
		"./img/screen_outdoor_animation/wall_screen_outdoor_3.xpm");
	add_img_to_garbage_memory(data, &data->textures.wall_screen_outdoor_4,
		"wall_screen_outdoor_4  ",
		"./img/screen_outdoor_animation/wall_screen_outdoor_2.xpm");
	add_img_to_garbage_memory(data, &data->textures.wall_screen_outdoor_5,
		"wall_screen_outdoor_5  ",
		"./img/screen_outdoor_animation/wall_screen_outdoor_1.xpm");
